...
export default function Administracao() {
    ...
    async function EditItemsUser(id) {
        var response = await Api.get('buscar/' + id);
                        ...
                        <table className="blueTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-primary"><center>CPF</center></th>
                            ...
                            {users.map((data) => {
                                ...
                                return (
                                    ...
                                    <td><center>{data.nome}</center></td>
                                    <td><center>{data.email}</center></td>
                                    <td><center>{data.cpf}</center></td>
                                    <td><center>
                                        <Button style={style} className="btn btn-default" variant="primary" size="sm" onClick={() => editUser(data.id)}>
                                        <i class="fas fa-pen"> Edita</i> 
                                        </Button>
                                        <Button style={style} className="btn btn-default" variant="danger" size="sm" onClick={() => delUsuario(data.id)}>
